...
export const fetchLoginRewards = () =>
  fetchTable<LoginReward>("login_rewards", { column: "claimed_on" });
...
export const useLoginRewards = () =>
  useQuery({ queryKey: queryKeys.loginRewards, queryFn: fetchLoginRewards });